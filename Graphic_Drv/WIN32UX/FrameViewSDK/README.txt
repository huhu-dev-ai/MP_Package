Output Files
    ...
    Columns in FrameView_Summary.csv
        ...
        Avg FPS                      Average frames per second, using rendered FPS scheduling metrics. One of 3 key metrics for evaluating a game.
        ...
        1% High FPS                  Takes the fastest 1% frames and averages them.
        ...
        0.1% FPS                     The fps separating the slowest .1% framerates from the fastest 99.9% framerates (like a percentile measurement)
        1% FPS                       The fps separating the slowest 1% framerates from the fastest 99% framerates (like a percentile measurement)
        5% FPS                       The fps separating the slowest 5% framerates from the fastest 95% framerates (like a percentile measurement)
        10% FPS                      The fps separating the slowest 10% framerates from the fastest 90% framerates (like a percentile measurement)
